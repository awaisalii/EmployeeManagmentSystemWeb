...
export class ProfileComponent implements OnInit {
  ...
  constructor(private service: EmployeeService, public screen: ScreenService, private ref: ChangeDetectorRef , private selectBoxService:SelectBoxesService ) {
    forkJoin([
  ...
  getAddressItems() {
    return [
      { dataField: 'country',colSpan: 2, },
      { dataField: 'city',colSpan: 2, },
      {
        dataField: 'state',
      },
      {
